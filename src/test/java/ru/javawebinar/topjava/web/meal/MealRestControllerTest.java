...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    void createInvalid() throws Exception {
        Meal invalid = new Meal(null, null, "Invalid", 200);
    ...
    void updateInvalid() throws Exception {
        Meal invalid = new Meal(MEAL1_ID, null, null, 6500);
    ...
    void updateDuplicate() throws Exception {
        Meal invalid = new Meal(MEAL1_ID, meal2.getDateTime(), "Invalid", 200);
        perform(MockMvcRequestBuilders.put(REST_URL + MEAL1_ID)
                .contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(invalid))
                .with(userHttpBasic(user)))
    ...
    void createDuplicate() throws Exception {
        Meal invalid = new Meal(null, adminMeal1.getDateTime(), "Invalid", 200);
        perform(MockMvcRequestBuilders.post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(invalid))
                .with(userHttpBasic(admin)))
